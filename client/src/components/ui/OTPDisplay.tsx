  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          onClick={handleCopy}
          className={cn('text-slate-400 hover:text-white transition-colors', copied && 'text-emerald-400')}
        >
      ...
      {timeLeft && (
        <span className={cn('text-xs font-sans', timeLeft === 'Expirado' ? 'text-red-400' : 'text-amber-400')}>
          {timeLeft}
        </span>
      )}
    </div>
