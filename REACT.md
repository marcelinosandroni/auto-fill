...
├── `core/`       - DI Container. Zero React aqui.
...
3. **Tailwind CSS** para estilização. Sem CSS modules, sem styled-components.
4. **Chrome Extension** usa a mesma base React com entry points separados (popup, options, content-script).
...
- `dashboard/` - Painel do usuário (histórico, configs)
- `extension/` - Popup da extensão + content scripts
